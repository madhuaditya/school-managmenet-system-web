      ...
      children: [
        ...
        { path: `${ROUTES.schoolResetPassword}/:token`, element: <SchoolResetPasswordPage /> },
        {
          ...
          children: [
            ...
            { path: 'my-leaves', element: <DashboardContentRoute /> },
            { path: 'leave-review', element: <DashboardContentRoute /> },
            ...
            {path: 'teachersSchool', element: <DashboardContentRoute /> },
            {path: 'adminSchool', element: <DashboardContentRoute /> },
            {path: 'staffSchool', element: <DashboardContentRoute /> }
          ],
        },
      ],
    }, 
